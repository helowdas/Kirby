...
import com.marbro.entities.player.modeloJugador.MyContactListener;
import com.marbro.entities.player.modeloJugador.Proto;
import com.marbro.scenes.Hud;

import static com.marbro.constants.Constantes.PPM;

public class Prototype implements Screen {
    ...
    public Prototype(MainGame game) {
        //Crear camara y hud
        this.game = game;
        ...
        colisiones = new MyContactListener();
    ...
    */
    public void loadBlocks(int layer, String uData){
    ...
    public void show() {
        ...
        prot = new Proto(world, stage, colisiones, 2, 15, stand, walk, fall1, fall2, jump);
        stage.addActor(prot);
